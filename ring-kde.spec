...
rm -rf libringclient
git clone https://gerrit-ring.savoirfairelinux.com/ring-lrc.git libringclient
cd libringclient
...
%changelog
* Fri May  1 2015 Guillaume Roguez <guillaume.roguez@savoirfairelinux.com> - 2.2.0-1
